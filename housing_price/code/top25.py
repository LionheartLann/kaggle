...
logging.info('train missing data overview: %s', NAs[NAs.sum(axis=1) > 0])
...
# Final model is an average of GBest and Elastic Net
# Retraining models
...
pd.DataFrame({'Id': test.Id, 'SalePrice': Final_labels}).to_csv(time+'top25.csv', index =False)    
